...
public class Main {
    public static void main(String[] args) {
        ...
        //
        //
        //// GUI.Product product = productFactory.createProduct(id, name,
        ...
        // throw new
        // GUI.InsufficientQuantityException("No products exist. Please, add products
        // first.");
        // }
        // while (cont.equalsIgnoreCase("y")) {
        ...
        // System.out.println("Choose products and quantities, along with your payment
        // method, then confirm and make payment:");
        //
        // System.out.print("Enter product ID: ");
        // String id = scanner.nextLine();
        //
        ...
        // System.out.print("Enter your payment method (CASH, CREDIT_CARD,
        // MOBILE_PAYMENT): ");
        ...
        //
        // } catch (IllegalArgumentException | InputMismatchException e) {
        // System.out.println("Payment Error. Please make sure you use one of the
        // allowed payment methods: " + e);
